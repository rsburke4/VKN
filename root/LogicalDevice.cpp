...
namespace vkn {
	...
	LogicalDevice::LogicalDevice(vkn::PhysicalDevice *physicalDevice, VkSurfaceKHR surface, bool validationEnabled, const std::vector<const char*> validationLayers) {
